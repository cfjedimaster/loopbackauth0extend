...
module.exports = function(server) {
  ...
  router.post('/edit', checkAuth, (req, res) => {
    ...
    .catch(err => {
      ...
      adopted = cat.adopted;
      res.render('edit', {cat:cat, male:male, adopted:adopted, title:'Edit Cat', error:err.message});
    });
  });
  ...
  router.get('/login', (req, res) => {
    res.render('login', {title:'Login', nonav:true});
  });
  ...
  router.get('/ext_new', (req, res) => {
    res.render('ext_new', {title:'New Cat Extension'});
  });

  router.get('/ext_edit', (req, res) => {
    res.render('ext_edit', {title:'Edit Cat Extension'});
  });

  router.get('/ext_adopt', (req, res) => {
    res.render('ext_adopt', {title:'Adopt Cat Extension'});
  });
